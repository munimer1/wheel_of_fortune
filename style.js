...
// Game Script research from http://codereview.stackexchange.com/
    ...
    WheelGame.prototype.createGuessPrompt = function (valueSpun, isVowel) {
        ...
        if (!this.puzzleSolved) {
            ...
            if (isVowel) {
                ...
                letter = prompt("YOU SPUN A " + valueSpun + " PLEASE ENTER A LETTER", "");
            }
            if (letter) {
...
var Game = new WheelGame([
    "patrice is handsome","bj is short","doctor who","wheel of fortune",
    "facebook", "twitter", "google", "sea world","i am sparta", "nydca"]);